...
class Job:
    ...
    cycle_idx: int = 0        
    max_cycles: int = 1       
    pending_stage: Optional[str] = None # 추가된 변수 
...
class FactoryConfig: # Factory 설정
    ...
    job_cycles: int = 2                        # 고정
    sim_time: float = 3600.0                   # 시뮬레이션 시간, 입력 값
...
class GlobalVariable:
    ...
    def init_all(self):
        ...
        # Output buffer wait time tracking: {machine_name: [(job_id, wait_time), ...]}
        self.output_wait_times: Dict[str, List[Tuple[str, float]]] = {}
