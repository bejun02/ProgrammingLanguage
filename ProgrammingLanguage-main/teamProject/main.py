...
if __name__ == "__main__":
    ...
    # AMR 대수
    amr_count = 3
    cfg = sim_core.FactoryConfig(sim_time=5000, seed=20, feed_sequence=("ProdA","ProdB"), amr_count=amr_count, machine_counts=machine_counts,machine_positions= machine_positions)
    sim_core.simulate(cfg)
    # result 
    information()
    profit(amr_count=1,machine_counts={"A":4,"B":4,"C":4,"D":4,"E":4})
